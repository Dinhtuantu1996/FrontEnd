              ...
              <div className="col-md-12">
                ...
                <div className="product-cart d-flex">
                  <div className="one-forth">
                    <div className="product-img" style={{backgroundImage: 'url(bootstrap2/images/item-6.jpg)'}}>
                    </div>
                ...
                <div className="product-cart d-flex">
                  <div className="one-forth">
                    <div className="product-img" style={{backgroundImage: 'url(bootstrap2/images/item-7.jpg)'}}>
                    </div>
                    <div className="display-tc">
                      <h3>Product Name</h3>
                    </div>
                ...
                <div className="product-cart d-flex">
                  <div className="one-forth">
                    <div className="product-img" style={{backgroundImage: 'url(bootstrap2/images/item-8.jpg)'}}>
                    </div>
                    <div className="display-tc">
                      <h3>Product Name</h3>
                    </div>
