      ...
      <div className="col-sm-12 text-center">
        <p>
          <span>{/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}
            Copyright © All rights reserved | This template is made with <i className="icon-heart" aria-hidden="true" /> by <a href="#" target="_blank">Tuph09235</a>
            {/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}</span> 
          <span className="block"> Demo Images: <a href="#" target="_blank">Unsplash</a> , <a href="#" target="_blank">Pexels.com</a></span>
        </p>
      </div>
    </div>
  </div>
